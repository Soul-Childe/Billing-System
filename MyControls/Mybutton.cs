...
namespace MyControls
{
    public partial class Mybutton : Button
    {
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            Color clr = this.BackColor;//初始化颜色
            int btnOff = 0;//按钮边距
            int shadowOff = 0;//阴影边距
            switch (mouseActionType)
            {
                case MouseActionType.None://初始化
                    clr = Color.LightSteelBlue;
                    shadowOff = 2;
                    break;
            ...
            GraphicsPath gpath1 = this.GetGraphicsPath(rc1, 10);
            ...
            GraphicsPath gpath2 = this.GetGraphicsPath(rc2, 10);
